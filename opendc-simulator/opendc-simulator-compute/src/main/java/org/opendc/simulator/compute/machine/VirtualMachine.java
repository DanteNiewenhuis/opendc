...
public class VirtualMachine extends FlowNode implements FlowConsumer, FlowSupplier {
    ...
    public PerformanceCounters getPerformanceCounters() {return performanceCounters;}

    public SimWorkload getActiveWorkload() {return activeWorkload;}
    ...
    public float getCpuCapacity() {return cpuCapacity;}
    ...
    public SimCpu getCpu() {return machine.getCpu();}
